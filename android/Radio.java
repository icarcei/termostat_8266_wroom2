...
public class Radio extends AppCompatActivity implements AsyncResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        thermo = new Thermo(getApplicationContext(), file, Radio.this, 1, Local);
        sensorAdapter = new SensorAdapter(getApplicationContext(), thermo.getRadio().sensorList);
        ...
        //Toast.makeText(this, "Radio creat File="+file+" and Name="+thermo.getName(), Toast.LENGTH_LONG).show();
                ...
                builder.setPositiveButton(R.string.rename, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if(!editText.getText().toString().isEmpty()){
                            thermo.stoptimertask();
                            thermo.setRadio(sensorAdapter.getItem(info.position).number, editText.getText().toString());
                            refreshed(1);
                            thermo.startTimer();
                        }
                    }
            ...
            case R.id.idcmAddsensor:
                ...
                buttonadd.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        AlertDialog.Builder builderr = new AlertDialog.Builder(Radio.this);
                        builderr.setTitle(R.string.warning);
                        builderr.setIcon(R.drawable.warning);
                        ...
                        if(id.length() > 22){// has correct length
                            ...
                            try{
                                ...
                                if(thermo.getRadio().SensorWithId(iid) == null) {
